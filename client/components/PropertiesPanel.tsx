...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  if (!selectedElement) {
    return (
      <div className="w-[300px] shrink-0 p-4 bg-panel border-l border-border flex items-center justify-center text-[13px] text-secondary transition-colors duration-200">
        No element selected
      </div>
    );
  }
  ...
  return (
    <div className="w-[300px] shrink-0 p-4 bg-panel border-l border-border flex flex-col text-[13px] overflow-y-auto transition-colors duration-200">
      {/* Header */}
